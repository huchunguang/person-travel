						...
						<form class="form-horizontal pt20" role="form" id="FormDelegation" method="POST" action="{{url('delegate/store')}}">
							...
							<div class="form-body row">
								<div class="row">
									<div class="form-group col-md-6">
										...
										<div class="col-md-8">
											<select id="manager_id" name="ManagerID" class="form-control input-sm select2">
												<option value=""></option>
												@foreach($userListBySite as $userItem) @if(!old('ManagerID') && Auth::user()->UserID==$userItem['UserID'])
									...
									<div class="form-group col-md-6">
										<label for="site_id" class="col-md-4 control-label"></label>
										<div class="col-md-8"></div>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label for="country_id" class="col-md-4 control-label">Delegated Country</label>
										<div class="col-md-8">
											<select id="country_id" name="country_id" class="form-control input-sm select2">
												<option value=""></option>
												@foreach($countryList as $countryItem) @if(($CountryAssignedID && $CountryAssignedID==$countryItem['CountryID']) || (old('country_id')==$countryItem['CountryID']))
									...
									<div class="form-group col-md-6">
										...
										<div class="col-md-8">
											<select class="form-control js-data-example-ajax delegate_id" name="ManagerDelegationID" id="delegate_id">
							...
							<div class="row form-actions text-right">
								<div id="btnLeaveControl">
									<button id="delegateEdit" type="button" accesskey="I" class="btn yellow-casablanca">
										<i class="fa fa-pencil"></i> Ed<u>i</u>t
									</button>
									<button id="delegateSave" disabled="" type="button" accesskey="S" class="btn green-jungle">
