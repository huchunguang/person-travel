                                ...
                                <div class="portlet-body" style="display: block;">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($announcementList as $announceItem)
                                                <tr>
                                                    <td> 1 </td>
                                                    ...
                                                    <td>
                                                        <button type="button" accesskey="I" onclick="window.location.href='/etravel/announcement/{{$announceItem['id']}}/edit'" class="btn yellow-gold leave-type-button">
													   		<i class="fa fa-pencil"></i> Ed<u>i</u>t
														</button>
														<button type="button" accesskey="D" onclick="announcementDel({{$announceItem['id']}})" class="btn red-mint leave-type-button">
