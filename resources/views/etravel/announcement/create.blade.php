							...
							<div class="form-body">
								...
								<div class="alert alert-success display-hide">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																<select id="siteSel" name="site" class="form-control input-sm select2">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<select id="typeid" name="typeid" class="form-control input-sm select2">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div style="position: relative;">
																<input type="text" name="date_effectivity"
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="EmploymentStatusList" class="">Announcement:</label>
                                        <textarea id="announcement"  style="height:400px;max-height:500px;" name="content" class="form-control" placeholder="这里是内容"></textarea>
                                    </div>
                                </div>
