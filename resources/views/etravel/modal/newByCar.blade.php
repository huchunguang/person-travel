						...
						<div class="col-md-6">
							<div class="form-group" style="margin-bottom: 0px;">
								<label class="control-label">From</label>
								 ...
								 <input type="text" id="flight_from" name="flight_from[]" class="form-control"  data-provide="typeahead" data-value="" autocomplete="off" placeholder="">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="flight_to" name="flight_to[]" class="form-control"  data-provide="typeahead" data-value="" autocomplete="off" placeholder="">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<select class="form-control select2 airlineSel" style="width: 100%" name="airline_or_train" id="airline_or_train" required style="display:inline">
											<option value="2" data-id="">By Car</option>
										</select>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control select2" name="class_flight[]" id="classFlightSel" required style="display: inline" disabled>
