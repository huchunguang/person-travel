				...
				<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject bold uppercase">Business Travel Request</span>
						</div>
					</div>
					<div class="portlet-body form">
						...
						<form action="{{url('/etravel/trip/storeNational')}}" method="post" enctype="multipart/form-data" id="nationTripCreate" class="horizontal-form">
							...
							<input type="hidden" name="is_by_car" value="1" />
							<div class="form-body">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select id="destinationSel" name="destination[]" class="form-control input-sm select2" multiple>
												...
												<option data-region="{{$countryItem['IsAsia']}}" value="{{$countryItem['CountryID']}}" <?php if(in_array($countryItem['CountryID'], old('destination',[]))){echo "selected";}?>>{{$countryItem['Country']}}</option>
												@endforeach
											</select>
										</div>
									</div>
									...
									<div class="col-md-3" style="padding-right: 0;">
										<div class="form-group">
											...
											<select id="department_approver" name="department_approver" class="form-control input-sm select2">
												@foreach ($approvers as $item) @if($item['UserID'] == old('department_approver'))
													...
													<div class="fileinput fileinput-new" data-provides="fileinput" style="margin-top: 5px; margin-bottom: 0;">
														<div class="input-group input-large">
															...
															<span class="input-group-addon btn btn-file yellow-gold">
																...
																<input type="file" name="purpose_file" value="{{old('purpose_file')}}">
															</span>
								...
								<div class="row">
									<div class="col-md-12">
										<ul id="myTab" class="nav nav-tabs">
											<li class="active">
												<a href="#home" data-toggle="tab">ITINERARY</a>
											</li>
											<li>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label">
																<button onclick="showByCar()" type="button" class="btn btn-primary">
												...
												<table id="flightLtinerary" class="table table-bordered table-striped table-condensed flip-content">
													<thead>
														<tr>
															...
															<td class="text-center text-danger">Transport</td>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="passport_fullname" value="{{old('passport_fullname')}}">
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="nric_no" value="{{old('nric_no')}}">
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="nric_num" value="{{old('nric_num')}}">
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="elationship" value="{{old('elationship')}}">
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
																...
																<div class="form-group">
																	...
																	<div class="input-group">
																		<div class="icheck-inline">
																			<label>
																				<input type="radio" name="room_type" class="icheck" value="double" <?php if(old('room_type')=='double'){echo 'checked';}?>>
																				Double
																			</label>
																			<label>
																				<input type="radio" name="room_type" class="icheck" value="king" <?php if(old('room_type')=='king'){echo 'checked';}?>>
																				King
																			</label>
																			<label>
																				<input type="radio" name="room_type" class="icheck" value="suite" <?php if(old('room_type')=='suite'){echo 'checked';}?>>
																				Suite
																			</label>
																			<label>
																				<input type="radio" name="room_type" class="icheck" value="standard" <?php if(old('room_type')=='standard'){echo 'checked';}?>>
																				Standard
																			</label>
																		</div>
																	</div>
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="per_hotel_name" value="{{old('per_hotel_name')}}">
																	</div>
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="input-group">
																		<div class="icheck-inline">
																			<label>
																				<input type="radio" name="smoking" class="icheck" value="1" <?php if(old('smoking')=='1'){echo 'selected';}?>>
																				Smoking
																			</label>
																			<label>
																				<input type="radio" name="smoking" class="icheck" value="0" <?php if(old('smoking')=='0'){echo 'selected';}?>>
																				Non Smoking
																			</label>
																		</div>
																	</div>
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="rate_per_night" value="{{old('rate_per_night')}}">
																	</div>
																</div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="no_of_nights" value="{{old('no_of_nights')}}">
																	</div>
																</div>
															</div>
														</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="portlet box default">
											...
											<div class="portlet-body form">
												<textarea id="extra_comment" name="extra_comment" class="form-control" style="overflow-y: scroll;" rows="2">{{old('extra_comment')}}</textarea>
											</div>
										</div>
									</div>
								</div>
