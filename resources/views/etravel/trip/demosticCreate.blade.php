								...
								<div class="col-md-7">
									<select name="cost_center_id"
										...
										<option value="{{ $costItem['CostCenterID'] }}">&lt;&nbsp;{{
											$costItem['CostCenterCode'] }}&nbsp;&gt;</option> @endforeach
									</select>
								</div>
							</div>
							<div class="form-group col-md-6">
								...
								<table class="table table-bordered" id="requestTable">
									...
									<tbody>
										<tr id="trOne">
											...
											<td class="col-md-1"><input type="text" name="contact_name[]"
												id="" style="width: 70px;" /></td>
											<td class="col-md-1">
											<select class="form-control" name="purpose_id[]"> 
													@foreach ($purposeCats as $item)
													<option value="{{ $item['purpose_id'] }}">
														&lt;&nbsp;{{$item['purpose_catgory'] }}&nbsp;&gt;
													</option> 
													@endforeach
											</select>
											</td>
											<td class="col-md-1"><input type="text" name="purpose_desc[]"
						...
						<div class="row">
							<div class="form-group col-md-10 col-md-push-1">
								<label for="approver_comment" class="control-label"> Approvers
									Comment <span class="required" aria-required="true"> * </span>
								</label>
