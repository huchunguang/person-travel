															...
															<tr id="trOne">
																...
																<td>
																	...
																	<select class="form-control select2" id="datetime_time" name="datetime_time[]" style="width: 100%">
																		<option value="12:00 AM" <?php if($item['datetime_time']=='12:00 AM'){echo 'selected';}?>>12:00 AM</option>
																		<option value="12:30 AM" <?php if($item['datetime_time']=='12:30 AM '){echo 'selected';}?>>12:30 AM</option>
																		<option value="1:00 AM" <?php if($item['datetime_time']=='1:00 AM '){echo 'selected';}?>>1:00 AM</option>
																		<option value="1:30 AM" <?php if($item['datetime_time']=='1:30 AM '){echo 'selected';}?>>1:30 AM</option>
																		<option value="2:00 AM" <?php if($item['datetime_time']=='2:00 AM '){echo 'selected';}?>>2:00 AM</option>
																		<option value="2:30 AM" <?php if($item['datetime_time']=='2:30 AM '){echo 'selected';}?>>2:30 AM</option>
																		<option value="3:00 AM" <?php if($item['datetime_time']=='3:00 AM '){echo 'selected';}?>>3:00 AM</option>
																		<option value="3:30 AM" <?php if($item['datetime_time']=='3:30 AM '){echo 'selected';}?>>3:30 AM</option>
																		<option value="4:00 AM" <?php if($item['datetime_time']=='4:00 AM '){echo 'selected';}?>>4:00 AM</option>
																		<option value="4:30 AM" <?php if($item['datetime_time']=='4:30 AM '){echo 'selected';}?>>4:30 AM</option>
																		<option value="5:00 AM" <?php if($item['datetime_time']=='5:00 AM '){echo 'selected';}?>>5:00 AM</option>
																		<option value="5:30 AM" <?php if($item['datetime_time']=='5:30 AM '){echo 'selected';}?>>5:30 AM</option>
																		<option value="6:00 AM" <?php if($item['datetime_time']=='6:00 AM '){echo 'selected';}?>>6:00 AM</option>
																		<option value="6:30 AM" <?php if($item['datetime_time']=='6:30 AM '){echo 'selected';}?>>6:30 AM</option>
																		<option value="7:00 AM" <?php if($item['datetime_time']=='7:00 AM '){echo 'selected';}?>>7:00 AM</option>
																		<option value="7:30 AM" <?php if($item['datetime_time']=='7:30 AM '){echo 'selected';}?>>7:30 AM</option>
																		<option value="8:00 AM" <?php if($item['datetime_time']=='8:00 AM '){echo 'selected';}?>>8:00 AM</option>
																		<option value="8:30 AM" <?php if($item['datetime_time']=='8:30 AM '){echo 'selected';}?>>8:30 AM</option>
																		<option value="9:00 AM" <?php if($item['datetime_time']=='9:00 AM '){echo 'selected';}?>>9:00 AM</option>
																		<option value="9:30 AM" <?php if($item['datetime_time']=='9:30 AM '){echo 'selected';}?>>9:30 AM</option>
																		<option value="10:00 AM" <?php if($item['datetime_time']=='10:00 AM '){echo 'selected';}?>>10:00 AM</option>
																		<option value="10:30 AM" <?php if($item['datetime_time']=='10:30 AM '){echo 'selected';}?>>10:30 AM</option>
																		<option value="11:00 AM" <?php if($item['datetime_time']=='11:00 AM '){echo 'selected';}?>>11:00 AM</option>
																		<option value="11:30 AM" <?php if($item['datetime_time']=='11:30 AM '){echo 'selected';}?>>11:30 AM</option>
																		<option value="12:00 AM" <?php if($item['datetime_time']=='12:00 AM '){echo 'selected';}?>>12:00 PM</option>
																		<option value="12:30 AM" <?php if($item['datetime_time']=='12:00 AM '){echo 'selected';}?>>12:30 PM</option>
																		<option value="1:00 PM" <?php if($item['datetime_time']=='1:00 PM '){echo 'selected';}?>>1:00 PM</option>
																		<option value="1:30 PM" <?php if($item['datetime_time']=='1:30 PM '){echo 'selected';}?>>1:30 PM</option>
																		<option value="2:00 PM" <?php if($item['datetime_time']=='2:00 PM '){echo 'selected';}?>>2:00 PM</option>
																		<option value="2:30 PM" <?php if($item['datetime_time']=='2:30 PM '){echo 'selected';}?>>2:30 PM</option>
																		<option value="3:00 PM" <?php if($item['datetime_time']=='3:00 PM '){echo 'selected';}?>>3:00 PM</option>
																		<option value="3:30 PM" <?php if($item['datetime_time']=='3:30 PM '){echo 'selected';}?>>3:30 PM</option>
																		<option value="4:00 PM" <?php if($item['datetime_time']=='4:00 PM '){echo 'selected';}?>>4:00 PM</option>
																		<option value="4:30 PM" <?php if($item['datetime_time']=='4:30 PM '){echo 'selected';}?>>4:30 PM</option>
																		<option value="5:00 PM" <?php if($item['datetime_time']=='5:00 PM '){echo 'selected';}?>>5:00 PM</option>
																		<option value="5:30 PM" <?php if($item['datetime_time']=='5:30 PM '){echo 'selected';}?>>5:30 PM</option>
																		<option value="6:00 PM" <?php if($item['datetime_time']=='6:00 PM '){echo 'selected';}?>>6:00 PM</option>
																		<option value="6:30 PM" <?php if($item['datetime_time']=='6:30 PM '){echo 'selected';}?>>6:30 PM</option>
																		<option value="7:00 PM" <?php if($item['datetime_time']=='7:00 PM '){echo 'selected';}?>>7:00 PM</option>
																		<option value="7:30 PM" <?php if($item['datetime_time']=='7:30 PM '){echo 'selected';}?>>7:30 PM</option>
																		<option value="8:00 PM" <?php if($item['datetime_time']=='8:00 PM '){echo 'selected';}?>>8:00 PM</option>
																		<option value="8:30 PM" <?php if($item['datetime_time']=='8:30 PM '){echo 'selected';}?>>8:30 PM</option>
																		<option value="9:00 PM" <?php if($item['datetime_time']=='9:00 PM '){echo 'selected';}?>>9:00 PM</option>
																		<option value="9:30 PM" <?php if($item['datetime_time']=='9:30 PM '){echo 'selected';}?>>9:30 PM</option>
																		<option value="10:00 PM" <?php if($item['datetime_time']=='10:00 PM '){echo 'selected';}?>>10:00 PM</option>
																		<option value="10:30 PM" <?php if($item['datetime_time']=='10:30 PM '){echo 'selected';}?>>10:30 PM</option>
																		<option value="11:00 PM" <?php if($item['datetime_time']=='11:00 PM '){echo 'selected';}?>>11:00 PM</option>
																		<option value="11:30 PM" <?php if($item['datetime_time']=='11:30 PM '){echo 'selected';}?>>11:30 PM</option>
																	</select>
