...
<div class="col-md-12">
	...
	<div class="portlet box yellow">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-comments"></i>List of Shift
			</div>
			<div class="actions">
<!-- 				saveIggBut -->
				<div class="btn-group btn-group-devided" data-toggle="modal" data-target="#newShift" accessKey="N">
		...
		<div class="portlet-body" style="display: block;">
			<div class="table-scrollable">
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						<tr id="TableClassRowID-{{$item->id}}">
							...
							<td>
								<button type="button" onclick="shiftEdit({{$item['id']}})" accesskey="E" class="btn yellow-gold">
									<i class="fa fa-pencil"></i> Ed<u>i</u>t
								</button>
								<button type="button" onclick="shiftDel({{$item['id']}})" accesskey="D" class="btn red-mint">
				...
				<?php echo $shiftList->render();?>
			</div>
		</div>
	</div>
</div>
<script src="{{asset('/js/overtime/shift/index.js')}}"></script>
@include('overtime.modal.newShift') 
@endsection
