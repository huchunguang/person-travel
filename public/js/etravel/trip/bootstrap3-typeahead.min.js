				...
				function($) {
					...
					var Typeahead = function(element, options) {
						...
						this.$appendTo = this.options.appendTo ? $(this.options.appendTo)
								: null;
						this.fitToElement = typeof this.options.fitToElement == "boolean" ? this.options.fitToElement
								: false;
						this.shown = false;
						this.listen();
					...
					Typeahead.prototype = {
						...
						show : function() {
							...
							var scrollHeight = typeof this.options.scrollHeight == "function" ? this.options.scrollHeight
									.call()
							...
							if (this.shown) {
								...
								this.hasSameParent = this.$appendTo
										.is(this.$element.parent())
							} else {
							...
							var newTop = dropup ? "auto" : pos.top + pos.height
									+ scrollHeight;
							var right = $(element).hasClass(
									"dropdown-menu-right");
							...
							if (this.options.fitToElement === true) {
								element.css("width", this.$element.outerWidth()
										+ "px")
							}
							this.shown = true;
							return this
...
//							this.$element.data("active", null);
					...
					$.fn.typeahead = function(option) {
						...
						return this.each(function() {
							...
							if (!data)
								$this.data("typeahead", data = new Typeahead(
										this, options));
